...
public class MatchDialog extends javax.swing.JDialog {
     ...
     */
    public MatchDialog(java.awt.Frame parent, boolean modal, List<String> matches) {
        super(parent, modal);
        initComponents();
        
        this.setTitle("Match Übersicht");
        this.setLocationRelativeTo(null);
        tblMatches.setModel(new MatchTableModel(matches));
    }

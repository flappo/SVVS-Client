...
import svvsclient.presentation.messageListener.AcceptListener;
import svvsclient.presentation.messageListener.RefuseListener;
...
import svvsclient.presentation.tournamentListeners.CreateNewTournamentListener;
import svvsclient.presentation.tournamentListeners.EditTournamentListener;
import svvsclient.presentation.tournamentListeners.ShowTournamentListener;
import svvsclient.presentation.tournamentTeamListener.EditTournamentTeamListener;
...
public class MainForm extends javax.swing.JFrame {
    ...
    @EJB(name = "_cFactory1")
    private static ControllerFactoryRemote _cFactory1;
    ...
    private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilterActionPerformed
        ...
        personSorter = new TableRowSorter<PersonTableModel>((PersonTableModel) personTable.getModel());
    ...
    private void _personActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event__personActionPerformed
        try {
            ...
            if (_person.getSelectedItem() == null) {
                ...
                LinkedList<ITrainingTeamDTO> list = _cFactory2.getTeamController().loadTrainingTeams(trainingteamname);//controllerFactory.loadTeamController().loadTrainingTeams(trainingteamname);
                System.out.println(list.size());
                DefaultListModel<ITrainingTeamDTO> model = new DefaultListModel<ITrainingTeamDTO>();
        ...
        try {
            ...
            if (_team.getSelectedItem() == null) {
               ...
               // controllerFactory.loadPlayerToTeamController().AddPlayerToTeam(trainingteamid, sportsmanid, _position.getText());
                _cFactory2.getPlayerToTeam().AddPlayerToTeam(trainingteamid, sportsmanid, _position.getText());
            }
        } catch (Exception e) {
        }
...
//        _team.setRenderer(new DTORenderer());
        ...
        btnCreatePerson.addActionListener(new CreateNewPersonListener(personTable, _cFactory1));
        btnEditPerson.addActionListener(new EditPersonListener(personTable, _cFactory1));
        btRechte.addActionListener(new EditRolesListener(personTable, _cFactory1, roleController, editPersonRoleController));
        ...
        btnCreateTournament.addActionListener(new CreateNewTournamentListener(tournamentTable, _cFactory3, managerRoles));
        btnEditTournament.addActionListener(new EditTournamentListener(tournamentTable, _cFactory3));
        jButton1.addActionListener(new ShowTournamentListener(tournamentTable, _cFactory3, teamController));
        ...
        btnEditTeam.addActionListener(new EditTeamListener(trainingTeamTable, _cFactory2));
        ...
        btnEditTournamentTeam.addActionListener(new EditTournamentTeamListener(tournamentTeamTable, _cFactory2));
    ...
    private void loadControllers() throws RemoteException, NotBoundException, MalformedURLException, Exception {
       // controllerFactory = (IControllerFactory) Naming.lookup("rmi://localhost/SVVS");
        teamController = _cFactory2.getTeamController();//(ITeamController) controllerFactory.loadTeamController();
        personController = _cFactory1.getPersonController();//(IPersonController) controllerFactory.loadPersonController();
        departmentController = _cFactory1.getDepartmentController();//(IDepartmentController) controllerFactory.loadDepartmentController();
        tournamentController = _cFactory3.getTournamentController();//(ITournamentController) controllerFactory.loadTournamentController();
        roleController = _cFactory3.getRoleController();//(IRoleController) controllerFactory.loadRoleController();
        editPersonRoleController = _cFactory3.getEditPersonRole();//(IEditPersonRole) controllerFactory.loadEditPersonRole();
        tournamentTeamController = _cFactory2.getTournamentTeamController();//(ITournamentTeamController) controllerFactory.loadTournamentTeamController();
        messageController = _cFactory1.getMessageController();//(IMessageController) controllerFactory.loadMessageController();
    }
    ...
    private void checkRights() throws RemoteException {
        ...
        try {
            rights = _cFactory1.getAuthentificationController().getAllRights();
                    //controllerFactory.loadAuthentificationController().getAllRights();
        ...
        List<IRightDTO> missingRights = new LinkedList<IRightDTO>();
